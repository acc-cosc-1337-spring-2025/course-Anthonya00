...
{
	REQUIRE(is_number_even(2) == false);
	REQUIRE(is_number_even(3) == true);
}
...

{
	...
	REQUIRE(get_generation(1920) == "Greatest generation X");
	REQUIRE(get_generation(1800) == "Invalid year");
}

TEST_CASE("Test mneu option switch statement ")
{
